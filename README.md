...
🎓 **Double Degree** from BUE & London South Bank University  
🤖 **AI Engineer** specializing in LLMs & Multi-Agent Systems  
📝 **Published Researcher** - Paper under review in Q1 Journal (Springer)  
🏆 **2x First Place Winner** - GP-Expo & Game Dev Competition at BUE  
⚡ **3x ECPC Participant** - Competitive Programming Enthusiast
...
Gained hands-on experience with Laravel framework and modern backend development practices.
...
![Education](https://img.shields.io/badge/EdTech-Innovation-orange?style=for-the-badge&logo=book&logoColor=white)
...
<br><b>Programming</b>
<br><br>Python • C++ • Java<br>C# • JavaScript • PHP
</td>
</tr>
</table>
...
**Bachelor of Computer Science** | AI Major | Double Degree  
**Oct 2021 - Jun 2025**

<img src="https://img.shields.io/badge/GPA-4.0%20%2F%204.0-success?style=for-the-badge&logo=academia&logoColor=white" />
<img src="https://img.shields.io/badge/Rank-3rd%20in%20University-gold?style=for-the-badge&logo=trophy&logoColor=white" />
...
```javascript
const currentFocus = {
    learning: ["Advanced RAG Architectures", "LLM Fine-tuning", "Multi-Modal AI"],
    building: ["Arabic Voice AI Systems", "Multi-Agent Applications"],
    exploring: ["AI Agent Frameworks", "Prompt Engineering Techniques"],
    reading: ["Latest AI Research Papers", "LLM Architecture Innovations"],
    goal: "Contributing to impactful AI solutions that matter 🌍"
};
```
